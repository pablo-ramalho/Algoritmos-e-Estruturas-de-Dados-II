...
public class Grafo{
     ...
     * <b>OBS: </b>este construtor só é usado para extratir a
     * árvore geradora mínima a partir do grafo original. <br></br>
     * O construtor com o parâmetro <b>numeroDeVertices</b> é usado
     * para criar o grafo original usando a entrada padrão pelo usuário
     * @param grafoOriginal
     * @param numeroDeVertices
     */
    public Grafo(Grafo grafoOriginal, Integer numeroDeVertices){
        this.vertice = new Lista[grafoOriginal.numeroDeVertices];
